...
class AddProjectViewController: UIViewController,UITextFieldDelegate,CustomButtonDelegate {
  ...
  @IBOutlet weak var addButton:UIButton!
    ...
    override func viewDidLoad() {
        ...
        var barBtnBack = UIBarButtonItem(title: "Back", style: UIBarButtonItemStyle.Plain, target: self, action: "handelNaviBackButtonAction")
        self.navigationItem.setLeftBarButtonItem(barBtnBack, animated: true)
        barBtnBack.tintColor = UIColor.whiteColor()
    ...
    func addBuleEffectImageView(){
        ...
        var frame2:CGRect = CGRect(x:self.view.frame.size.width, y: (self.view.frame.size.height-250)/2, width:self.view.frame.size.width , height: 44)
        ...
        dueDateTextField.keyboardType = UIKeyboardType.Default
        ...
        visualEffectVwDueDate = UIVisualEffectView (effect: blur1)
